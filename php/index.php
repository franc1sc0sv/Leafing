...
<body>
    ...
    <section>
            ...
            <div class="que-eventos">
                ...
                <div class="contenido_que-eventos">
                    ...
                    <div class="preguntas_eventos-eventos">
                        <p><a href="../html/about_us.html">¿Quiénes sómos?</a> </p>
                        <p><a href="../html/crear_evento.html">Crea un evento</a></p>
                    </div>

                    <a href="../html/comunity.html"><button class="button_que-eventos">Explorar más</button></a>
            ...
            <div class="container_recomendaciones">
                ...
                <div class="contribute_recomendaciones">
                    <div class="recomendacion">
                        ...
                        <a href="../html/concientizate.html"><button>Saber más</button></a>
                    </div>
                </div>
        ...
        <article class="¿Sabias-qué?">
            ...
            <div class="Datos-curiosos_container">
