            ...
            <div class="what_container">
                <div class="what_info">
                    <div class="what_info_border">
                        <div class="what_question">QUÉ HACEMOS?</div>
                        <div class="what_answer">We help protect the world’s tropical forests.</div>
                    </div>
                </div>
                <div class="what_values">
                    <div class="values_one"></div>
                    <div class="values_two"></div>
